...
### 3.2 Train a logistic regression model with y =Diabetes as target, x_1 =Plasma glucoseconcentration and x_2 =Age as fetures. Make a prediction for all observations by using r = 0.5
...
misscalssification_ex2
```
The misscalssification error is 0.2659713
